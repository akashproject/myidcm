...
<div class="col-12">
	...
	<div class="card">
        ...
        <div class="certificate" style="border: 1px solid;padding: 6px;position: relative;;width: 1040px;" id="certificate">
