			...
			"responsive": {
				...
				"1800": {
                    ...
                    <div class="item graphic-design">
                        <div class="course-card wow fadeInUp" data-wow-duration='1500ms' data-wow-delay='00ms'>
                            <div class="course-card__image">
                                <img src="{{ url('assets/frontend/images/courses/course-1-4.jpg') }}" alt="advanced Mastering UI/UX Design Fundamentals course">
                                <div class="course-card__ratings">
                                    <div class="eduhive-ratings">
                                        <span class="eduhive-ratings__icon">
                                            <i class="fa fa-star"></i>
                            ...
                            <div class="course-card__hover" style="background-image: url({{ url('assets/frontend/images/shapes/course-card-bg-1-1.png') }});">
                                <div class="course-card__hover__content">
                                    ...
                                    <h3 class="course-card__title course-card__title--hover"><a href="uiux-design.html">advanced Mastering UI/UX Design Fundamentals course</a></h3><!-- /.course-card__title -->
                                    <p class="course-card__text">The closest elephant is the most dangerous. We should have a meeting to discuss the details of the next</p><!-- /.course-card__text -->
                                    <div class="course-card__ratings course-card__ratings--hover">
                                        <div class="eduhive-ratings">
                                            <span class="eduhive-ratings__icon">
                                                <i class="fa fa-star"></i>
                        ...
                        <div class="course-card wow fadeInUp" data-wow-duration='1500ms' data-wow-delay='00ms'>
                            ...
                            <div class="course-card__hover" style="background-image: url({{ url('assets/frontend/images/shapes/course-card-bg-1-1.png') }});">
                                <div class="course-card__hover__content">
                                    ...
                                    <h3 class="course-card__title course-card__title--hover"><a href="data-science.html">The Data Science Revolution: Upgrading Your Skills</a></h3><!-- /.course-card__title -->
                                    <p class="course-card__text">We need to dialog around your choice of work attire we need more paper back of the net quick win yet today</p><!-- /.course-card__text -->
                                    <div class="course-card__ratings course-card__ratings--hover">
                                        <div class="eduhive-ratings">
                                            <span class="eduhive-ratings__icon">
                                                <i class="fa fa-star"></i>
                    ...
                    <div class="item digital-marketing">
                        <div class="course-card wow fadeInUp" data-wow-duration='1500ms' data-wow-delay='00ms'>
                            <div class="course-card__image">
                                <img src="{{ url('assets/frontend/images/courses/course-1-7.jpg') }}" alt="The SEO Become an Expert in Search Engine Optimization">
                                <div class="course-card__ratings">
                                    <div class="eduhive-ratings">
                                        <span class="eduhive-ratings__icon">
                                            <i class="fa fa-star"></i>
                            ...
                            <div class="course-card__content">
                                ...
                                <h3 class="course-card__title"><a href="search-engine-optimization.html">The SEO Become an Expert in Search Engine Optimization</a></h3><!-- /.course-card__title -->
                                <div class="course-card__info">
                                    <div class="course-card__lessons">
                                        <span class="course-card__lessons__icon">
                                            <i class="icon-open-book"></i>
                            ...
                            <div class="course-card__hover" style="background-image: url({{ url('assets/frontend/images/shapes/course-card-bg-1-1.png') }});">
                                <div class="course-card__hover__content">
                                    ...
                                    <h3 class="course-card__title course-card__title--hover"><a href="search-engine-optimization.html">The SEO Become an Expert in Search Engine Optimization</a></h3><!-- /.course-card__title -->
                                    <p class="course-card__text">T-shaped individual start procrastinating 2 hours get to do work while procrastinating open book</p><!-- /.course-card__text -->
                                    <div class="course-card__ratings course-card__ratings--hover">
                                        <div class="eduhive-ratings">
                                            <span class="eduhive-ratings__icon">
                                                <i class="fa fa-star"></i>
                                    ...
                                    <a href="search-engine-optimization.html" class="course-card__btn eduhive-btn eduhive-btn--border">
                                        <span>enroll now</span>
                                        <span class="eduhive-btn__icon">
                                            <span class="eduhive-btn__icon__inner"><i class="icon-right-arrow"></i></span>
                                        </span>
                    ...
                    <div class="item graphic-design">
                        <div class="course-card wow fadeInUp" data-wow-duration='1500ms' data-wow-delay='00ms'>
                            <div class="course-card__image">
                                <img src="{{ url('assets/frontend/images/courses/course-1-5.jpg') }}" alt="advanced Mastering graphics Design Fundamentals course">
                                <div class="course-card__ratings">
                                    <div class="eduhive-ratings">
                                        <span class="eduhive-ratings__icon">
                                            <i class="fa fa-star"></i>
                            ...
                            <div class="course-card__content">
                                ...
                                <h3 class="course-card__title"><a href="graphics-design.html">advanced Mastering graphics Design Fundamentals course</a></h3><!-- /.course-card__title -->
                                <div class="course-card__info">
                                    <div class="course-card__lessons">
                                        <span class="course-card__lessons__icon">
                                            <i class="icon-open-book"></i>
                            ...
                            <div class="course-card__hover" style="background-image: url({{ url('assets/frontend/images/shapes/course-card-bg-1-1.png') }});">
                                <div class="course-card__hover__content">
                                    ...
                                    <h3 class="course-card__title course-card__title--hover"><a href="graphics-design.html">advanced Mastering graphics Design Fundamentals course</a></h3><!-- /.course-card__title -->
                                    <p class="course-card__text">The flagpole bazooka that run it past the boss jump right in and banzai attack will they won't they its all greek</p><!-- /.course-card__text -->
                                    <div class="course-card__ratings course-card__ratings--hover">
                                        <div class="eduhive-ratings">
                                            <span class="eduhive-ratings__icon">
                                                <i class="fa fa-star"></i>
                    ...
                    <div class="item programming">
                        <div class="course-card wow fadeInUp" data-wow-duration='1500ms' data-wow-delay='00ms'>
                            <div class="course-card__image">
                                <img src="{{ url('assets/frontend/images/courses/course-1-3.jpg') }}" alt="From Zero to Website: A Web Development Adventure">
                                <div class="course-card__ratings">
                                    <div class="eduhive-ratings">
                                        <span class="eduhive-ratings__icon">
                                            <i class="fa fa-star"></i>
                            ...
                            <div class="course-card__hover" style="background-image: url({{ url('assets/frontend/images/shapes/course-card-bg-1-1.png') }});">
                                <div class="course-card__hover__content">
                                    ...
                                    <h3 class="course-card__title course-card__title--hover"><a href="web-development.html">From Zero to Website: A Web Development Adventure</a></h3><!-- /.course-card__title -->
                                    <p class="course-card__text">Yet today shall be a cloudy day, thanks to blue sky thinking, we can now deploy our new ui to the cloud</p><!-- /.course-card__text -->
                                    <div class="course-card__ratings course-card__ratings--hover">
                                        <div class="eduhive-ratings">
                                            <span class="eduhive-ratings__icon">
                                                <i class="fa fa-star"></i>
                    ...
                    <div class="item digital-marketing">
                        <div class="course-card wow fadeInUp" data-wow-duration='1500ms' data-wow-delay='00ms'>
                            <div class="course-card__image">
                                <img src="{{ url('assets/frontend/images/courses/course-1-10.jpg') }}" alt="Social Media Marketing Mastering course From Zero to Hero">
                                <div class="course-card__ratings">
                                    <div class="eduhive-ratings">
                                        <span class="eduhive-ratings__icon">
                                            <i class="fa fa-star"></i>
                            ...
                            <div class="course-card__content">
                                ...
                                <h3 class="course-card__title"><a href="digital-marketing.html">Social Media Marketing Mastering course From Zero to Hero</a></h3><!-- /.course-card__title -->
                                <div class="course-card__info">
                                    <div class="course-card__lessons">
                                        <span class="course-card__lessons__icon">
                                            <i class="icon-open-book"></i>
                            ...
                            <div class="course-card__hover" style="background-image: url({{ url('assets/frontend/images/shapes/course-card-bg-1-1.png') }});">
                                <div class="course-card__hover__content">
                                    ...
                                    <h3 class="course-card__title course-card__title--hover"><a href="digital-marketing.html">Social Media Marketing Mastering course From Zero to Hero</a></h3><!-- /.course-card__title -->
                                    <p class="course-card__text">Anim veritatis, so aliquip magna. Aut quis accusantium, doloremque suscipit, yet exercitation nostrum</p><!-- /.course-card__text -->
                                    <div class="course-card__ratings course-card__ratings--hover">
                                        <div class="eduhive-ratings">
                                            <span class="eduhive-ratings__icon">
                                                <i class="fa fa-star"></i>
                    ...
                    <div class="item graphic-design">
                        <div class="course-card wow fadeInUp" data-wow-duration='1500ms' data-wow-delay='00ms'>
                            <div class="course-card__image">
                                <img src="{{ url('assets/frontend/images/courses/course-1-15.jpg') }}" alt="advanced Mastering mobile app design Fundamentals course">
                                <div class="course-card__ratings">
                                    <div class="eduhive-ratings">
                                        <span class="eduhive-ratings__icon">
                                            <i class="fa fa-star"></i>
                            ...
                            <div class="course-card__content">
                                ...
                                <h3 class="course-card__title"><a href="graphics-design.html">advanced Mastering mobile app design Fundamentals course</a></h3><!-- /.course-card__title -->
                                <div class="course-card__info">
                                    <div class="course-card__lessons">
                                        <span class="course-card__lessons__icon">
                                            <i class="icon-open-book"></i>
                            ...
                            <div class="course-card__hover" style="background-image: url({{ url('assets/frontend/images/shapes/course-card-bg-1-1.png') }});">
                                <div class="course-card__hover__content">
                                    ...
                                    <h3 class="course-card__title course-card__title--hover"><a href="graphics-design.html">advanced Mastering mobile app design Fundamentals course</a></h3><!-- /.course-card__title -->
                                    <p class="course-card__text">Quasi nequeporro modi ullamco tempor, yet quaerat, for vitae. Ullamco quo, but ipsa, nor ullamco, and adipisicing</p><!-- /.course-card__text -->
                                    <div class="course-card__ratings course-card__ratings--hover">
                                        <div class="eduhive-ratings">
                                            <span class="eduhive-ratings__icon">
                                                <i class="fa fa-star"></i>
                    ...
                    <div class="item programming">
                        <div class="course-card wow fadeInUp" data-wow-duration='1500ms' data-wow-delay='00ms'>
                            <div class="course-card__image">
                                <img src="{{ url('assets/frontend/images/courses/course-1-8.jpg') }}" alt="Apps Development Mastering course From Zero to Hero">
                                <div class="course-card__ratings">
                                    <div class="eduhive-ratings">
                                        <span class="eduhive-ratings__icon">
                                            <i class="fa fa-star"></i>
                            ...
                            <div class="course-card__content">
                                ...
                                <h3 class="course-card__title"><a href="apps-development.html">Apps Development Mastering course From Zero to Hero</a></h3><!-- /.course-card__title -->
                                <div class="course-card__info">
                                    <div class="course-card__lessons">
                                        <span class="course-card__lessons__icon">
                                            <i class="icon-open-book"></i>
                            ...
                            <div class="course-card__hover" style="background-image: url({{ url('assets/frontend/images/shapes/course-card-bg-1-1.png') }});">
                                <div class="course-card__hover__content">
                                    ...
                                    <h3 class="course-card__title course-card__title--hover"><a href="apps-development.html">Apps Development Mastering course From Zero to Hero</a></h3><!-- /.course-card__title -->
                                    <p class="course-card__text">Baseline the procedure and samepage your department i am dead inside, and move the needle, so exposing new</p><!-- /.course-card__text -->
                                    <div class="course-card__ratings course-card__ratings--hover">
                                        <div class="eduhive-ratings">
                                            <span class="eduhive-ratings__icon">
                                                <i class="fa fa-star"></i>
                    ...
                    <div class="item digital-marketing">
                        <div class="course-card wow fadeInUp" data-wow-duration='1500ms' data-wow-delay='00ms'>
                            <div class="course-card__image">
                                <img src="{{ url('assets/frontend/images/courses/course-1-11.jpg') }}" alt="advanced Marketing Analytics Mastering course From Zero to Hero">
                                <div class="course-card__ratings">
                                    <div class="eduhive-ratings">
                                        <span class="eduhive-ratings__icon">
                                            <i class="fa fa-star"></i>
                            ...
                            <div class="course-card__content">
                                ...
                                <h3 class="course-card__title"><a href="digital-marketing.html">advanced Marketing Analytics Mastering course From Zero to Hero</a></h3><!-- /.course-card__title -->
                                <div class="course-card__info">
                                    <div class="course-card__lessons">
                                        <span class="course-card__lessons__icon">
                                            <i class="icon-open-book"></i>
                            ...
                            <div class="course-card__hover" style="background-image: url({{ url('assets/frontend/images/shapes/course-card-bg-1-1.png') }});">
                                <div class="course-card__hover__content">
                                    ...
                                    <h3 class="course-card__title course-card__title--hover"><a href="digital-marketing.html">advanced Marketing Analytics Mastering course From Zero to Hero</a></h3><!-- /.course-card__title -->
                                    <p class="course-card__text">Consectetur officia. Ea illo, yet velit, pariatur, but eu qui. Officia ullamco, for id dolores nihil Eius ipsam</p><!-- /.course-card__text -->
                                    <div class="course-card__ratings course-card__ratings--hover">
                                        <div class="eduhive-ratings">
                                            <span class="eduhive-ratings__icon">
                                                <i class="fa fa-star"></i>
                    ...
                    <div class="item graphic-design">
                        <div class="course-card wow fadeInUp" data-wow-duration='1500ms' data-wow-delay='00ms'>
                            <div class="course-card__image">
                                <img src="{{ url('assets/frontend/images/courses/course-1-16.jpg') }}" alt="advanced Mastering web UI/UX design Fundamentals course">
                                <div class="course-card__ratings">
                                    <div class="eduhive-ratings">
                                        <span class="eduhive-ratings__icon">
                                            <i class="fa fa-star"></i>
                            ...
                            <div class="course-card__content">
                                ...
                                <h3 class="course-card__title"><a href="uiux-design.html">advanced Mastering web UI/UX design Fundamentals course</a></h3><!-- /.course-card__title -->
                                <div class="course-card__info">
                                    <div class="course-card__lessons">
                                        <span class="course-card__lessons__icon">
                                            <i class="icon-open-book"></i>
                            ...
                            <div class="course-card__hover" style="background-image: url({{ url('assets/frontend/images/shapes/course-card-bg-1-1.png') }});">
                                <div class="course-card__hover__content">
                                    ...
                                    <h3 class="course-card__title course-card__title--hover"><a href="uiux-design.html">advanced Mastering web UI/UX design Fundamentals course</a></h3><!-- /.course-card__title -->
                                    <p class="course-card__text">Accusantium incidunt mollit. Nesciunt quisquam accusantium, yet sint. Sunt nequeporro Totam commodi Omnis ab, or dolor, for ut</p><!-- /.course-card__text -->
                                    <div class="course-card__ratings course-card__ratings--hover">
                                        <div class="eduhive-ratings">
                                            <span class="eduhive-ratings__icon">
                                                <i class="fa fa-star"></i>
                    ...
                    <div class="item programming">
                        <div class="course-card wow fadeInUp" data-wow-duration='1500ms' data-wow-delay='00ms'>
                            <div class="course-card__image">
                                <img src="{{ url('assets/frontend/images/courses/course-1-9.jpg') }}" alt="Web Design Wizardry Mastering Responsive Website">
                                <div class="course-card__ratings">
                                    <div class="eduhive-ratings">
                                        <span class="eduhive-ratings__icon">
                                            <i class="fa fa-star"></i>
                            ...
                            <div class="course-card__content">
                                ...
                                <h3 class="course-card__title"><a href="web-design.html">Web Design Wizardry Mastering Responsive Website</a></h3><!-- /.course-card__title -->
                                <div class="course-card__info">
                                    <div class="course-card__lessons">
                                        <span class="course-card__lessons__icon">
                                            <i class="icon-open-book"></i>
                            ...
                            <div class="course-card__hover" style="background-image: url({{ url('assets/frontend/images/shapes/course-card-bg-1-1.png') }});">
                                <div class="course-card__hover__content">
                                    ...
                                    <h3 class="course-card__title course-card__title--hover"><a href="web-design.html">Web Design Wizardry Mastering Responsive Website</a></h3><!-- /.course-card__title -->
                                    <p class="course-card__text">Race without a finish line we don't want to boil the ocean. What do you feel you would bring to the table</p><!-- /.course-card__text -->
                                    <div class="course-card__ratings course-card__ratings--hover">
                                        <div class="eduhive-ratings">
                                            <span class="eduhive-ratings__icon">
                                                <i class="fa fa-star"></i>
                    ...
                    <div class="item digital-marketing">
                        <div class="course-card wow fadeInUp" data-wow-duration='1500ms' data-wow-delay='00ms'>
                            <div class="course-card__image">
                                <img src="{{ url('assets/frontend/images/courses/course-1-12.jpg') }}" alt="advanced Affiliate Marketing Mastering course From Zero to Hero">
                                <div class="course-card__ratings">
                                    <div class="eduhive-ratings">
                                        <span class="eduhive-ratings__icon">
                                            <i class="fa fa-star"></i>
                            ...
                            <div class="course-card__content">
                                ...
                                <h3 class="course-card__title"><a href="digital-marketing.html">advanced Affiliate Marketing Mastering course From Zero to Hero</a></h3><!-- /.course-card__title -->
                                <div class="course-card__info">
                                    <div class="course-card__lessons">
                                        <span class="course-card__lessons__icon">
                                            <i class="icon-open-book"></i>
                            ...
                            <div class="course-card__hover" style="background-image: url({{ url('assets/frontend/images/shapes/course-card-bg-1-1.png') }});">
                                <div class="course-card__hover__content">
                                    ...
                                    <h3 class="course-card__title course-card__title--hover"><a href="digital-marketing.html">advanced Affiliate Marketing Mastering course From Zero to Hero</a></h3><!-- /.course-card__title -->
                                    <p class="course-card__text">Illum explicabo, and dicta. Velit magni modi est, but non, and aut, yet pariatur. Quo. Sunt do, so ex id ipsum</p><!-- /.course-card__text -->
                                    <div class="course-card__ratings course-card__ratings--hover">
                                        <div class="eduhive-ratings">
                                            <span class="eduhive-ratings__icon">
                                                <i class="fa fa-star"></i>
                    ...
                    <div class="item graphic-design">
                        <div class="course-card wow fadeInUp" data-wow-duration='1500ms' data-wow-delay='00ms'>
                            <div class="course-card__image">
                                <img src="{{ url('assets/frontend/images/courses/course-1-17.jpg') }}" alt="advanced Mastering professional logo design Fundamentals course">
                                <div class="course-card__ratings">
                                    <div class="eduhive-ratings">
                                        <span class="eduhive-ratings__icon">
                                            <i class="fa fa-star"></i>
                            ...
                            <div class="course-card__content">
                                ...
                                <h3 class="course-card__title"><a href="graphics-design.html">advanced Mastering professional logo design Fundamentals course</a></h3><!-- /.course-card__title -->
                                <div class="course-card__info">
                                    <div class="course-card__lessons">
                                        <span class="course-card__lessons__icon">
                                            <i class="icon-open-book"></i>
                            ...
                            <div class="course-card__hover" style="background-image: url({{ url('assets/frontend/images/shapes/course-card-bg-1-1.png') }});">
                                <div class="course-card__hover__content">
                                    ...
                                    <h3 class="course-card__title course-card__title--hover"><a href="graphics-design.html">advanced Mastering professional logo design Fundamentals course</a></h3><!-- /.course-card__title -->
                                    <p class="course-card__text">Accusantium incidunt mollit. Nesciunt quisquam accusantium, yet sint. Sunt nequeporro Totam commodi Omnis ab, or dolor, for ut</p><!-- /.course-card__text -->
                                    <div class="course-card__ratings course-card__ratings--hover">
                                        <div class="eduhive-ratings">
                                            <span class="eduhive-ratings__icon">
                    ...
                    <div class="item programming">
                        <div class="course-card wow fadeInUp" data-wow-duration='1500ms' data-wow-delay='00ms'>
                            <div class="course-card__image">
                                <img src="{{ url('assets/frontend/images/courses/course-1-14.jpg') }}" alt="advanced machine learning Mastering course From Zero to Hero">
                                <div class="course-card__ratings">
                                    <div class="eduhive-ratings">
                                        <span class="eduhive-ratings__icon">
                                            <i class="fa fa-star"></i>
                            ...
                            <div class="course-card__content">
                                ...
                                <h3 class="course-card__title"><a href="data-science.html">advanced machine learning Mastering course From Zero to Hero</a></h3><!-- /.course-card__title -->
                                <div class="course-card__info">
                                    <div class="course-card__lessons">
                                        <span class="course-card__lessons__icon">
                                            <i class="icon-open-book"></i>
                            ...
                            <div class="course-card__hover" style="background-image: url({{ url('assets/frontend/images/shapes/course-card-bg-1-1.png') }});">
                                <div class="course-card__hover__content">
                                    ...
                                    <h3 class="course-card__title course-card__title--hover"><a href="data-science.html">advanced machine learning Mastering course From Zero to Hero</a></h3><!-- /.course-card__title -->
                                    <p class="course-card__text">Natus nequeporro. Adipisicing consequat nemo. Illum. Aliquip reprehenderit lorem duis, yet eum, and quasi qui Veritatis</p><!-- /.course-card__text -->
                                    <div class="course-card__ratings course-card__ratings--hover">
                                        <div class="eduhive-ratings">
                                            <span class="eduhive-ratings__icon">
                                                <i class="fa fa-star"></i>
                    ...
                    <div class="item digital-marketing">
                        <div class="course-card wow fadeInUp" data-wow-duration='1500ms' data-wow-delay='00ms'>
                            <div class="course-card__image">
                                <img src="{{ url('assets/frontend/images/courses/course-1-13.jpg') }}" alt="advanced Email Marketing Mastering course From Zero to Hero">
                                <div class="course-card__ratings">
                                    <div class="eduhive-ratings">
                                        <span class="eduhive-ratings__icon">
                                            <i class="fa fa-star"></i>
                            ...
                            <div class="course-card__content">
                                ...
                                <h3 class="course-card__title"><a href="digital-marketing.html">advanced Email Marketing Mastering course From Zero to Hero</a></h3><!-- /.course-card__title -->
                                <div class="course-card__info">
                                    <div class="course-card__lessons">
                                        <span class="course-card__lessons__icon">
                                            <i class="icon-open-book"></i>
                            ...
                            <div class="course-card__hover" style="background-image: url({{ url('assets/frontend/images/shapes/course-card-bg-1-1.png') }});">
                                <div class="course-card__hover__content">
                                    ...
                                    <h3 class="course-card__title course-card__title--hover"><a href="digital-marketing.html">advanced Email Marketing Mastering course From Zero to Hero</a></h3><!-- /.course-card__title -->
                                    <p class="course-card__text">Et velit, for inventore ab, and quaerat suscipit. Minim. Minim adipisci. Totam architecto for non, so aut, for veniam pariatur</p><!-- /.course-card__text -->
                                    <div class="course-card__ratings course-card__ratings--hover">
                                        <div class="eduhive-ratings">
                                            <span class="eduhive-ratings__icon">
                                                <i class="fa fa-star"></i>
                    ...
                    <div class="item graphic-design">
                        <div class="course-card wow fadeInUp" data-wow-duration='1500ms' data-wow-delay='00ms'>
                            <div class="course-card__image">
                                <img src="{{ url('assets/frontend/images/courses/course-1-18.jpg') }}" alt="advanced Mastering business card design Fundamentals course">
                                <div class="course-card__ratings">
                                    <div class="eduhive-ratings">
                                        <span class="eduhive-ratings__icon">
                                            <i class="fa fa-star"></i>
                            ...
                            <div class="course-card__content">
                                ...
                                <h3 class="course-card__title"><a href="graphics-design.html">advanced Mastering business card design Fundamentals course</a></h3><!-- /.course-card__title -->
                                <div class="course-card__info">
                                    <div class="course-card__lessons">
                                        <span class="course-card__lessons__icon">
                                            <i class="icon-open-book"></i>
                            ...
                            <div class="course-card__hover" style="background-image: url({{ url('assets/frontend/images/shapes/course-card-bg-1-1.png') }});">
                                <div class="course-card__hover__content">
                                    ...
                                    <h3 class="course-card__title course-card__title--hover"><a href="graphics-design.html">advanced Mastering business card design Fundamentals course</a></h3><!-- /.course-card__title -->
                                    <p class="course-card__text">Perspiciatis tempor, but perspiciatis, adipisicing, but consequat magna, so illo. Cupidatat laudantium. Quis nihil illo</p><!-- /.course-card__text -->
                                    <div class="course-card__ratings course-card__ratings--hover">
                                        <div class="eduhive-ratings">
                                            <span class="eduhive-ratings__icon">
                                                <i class="fa fa-star"></i>
