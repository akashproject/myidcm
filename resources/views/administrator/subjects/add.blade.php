				...
				<div class="row mb-5">
					<div class="col-md-7" >
						...
						<div class="mb-3 row">
							...
							<div class="col-md-9">
								<input name="no_of_topic" class="form-control" type="text" value="" id="no_of_topic" placeholder="Enter Total Topic" >
							</div>
						</div>
						<div class="mb-3 row">
							<label for="duration" class="col-sm-3 control-label col-form-label">Duration</label>
							<div class="col-md-9">
								<input name="duration" class="form-control" type="text" value="" id="duration" placeholder="Enter Duration" >
							</div>
						</div>
					</div>
					...
					<div class="col-md-5">	
						<div class="mb-3 row">
							...
							<div class="col-sm-9">
								<select name="enable_otp" id="enable_otp" class="select2 form-control custom-select">	
						...
						<div class="mb-2 row">
							<label for="banner" class="col-sm-3 text-left control-label col-form-label">Banner</label>
							<div class="col-sm-9">
