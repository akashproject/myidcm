...
<div class="row">
    ...
    <div class="col-xxl">
        <div class="card mb-4">
            ...
            <div class="card-body">
                <form method="post" action="{{ route('admin-save-student') }}" enctype="multipart/form-data" >
                @csrf
                <div class="row mb-3">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <select class="form-select" id="exampleFormControlSelect1" aria-label="Default select example" name="status">
                            ...
                            <option value="1" {{($student->status == 1)? 'selected':'' }}>Enable</option>
                            <option value="0" {{($student->status == 0)? 'selected':'' }}>Disable</option>
                        </select>
                    </div>
                </div>
